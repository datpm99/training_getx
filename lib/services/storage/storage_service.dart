...
class StorageService extends GetxService implements BaseService {
  ...
  bool get signSuccess => _box.read(_Keys.signSuccess);
  set signSuccess(bool value) => _write(_Keys.signSuccess, value);
  ...
  String get modules => _box.read(_Keys.modules) ?? '';
  set modules(String value) => _write(_Keys.modules, value);
...
abstract class _Keys {
  ...
  static const String signSuccess = 'sign_success';
